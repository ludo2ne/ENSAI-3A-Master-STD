...
Ces [TP](https://ludo2ne.github.io/ENSAI-2A-Big-Data/){target="_blank"} initient les étudiants à l'architecture et aux concepts de Spark pour le traitement de données distribuées et le calcul statistique. Les participants apprendront à produire des analyses et à traiter des flux de données.
...
## Anciens cours{.unnumbered}

### Systèmes répartis {.unnumbered}

L'enseignant n'est plus disponible.
Ce cours était en fait plutôt centré sur le Big Data et recoupait avec celui de Shadi.
...
### Sécurité des données {.unnumbered}

L'enseignant n'est plus disponible.
Le cours était apprécié, mais recoupait avec d'autres et pas indispensable selon les élèves.
