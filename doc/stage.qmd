...
Une offre ou un sujet de stage devra contenir les éléments suivants :

- Contexte, description de la structure, de l'équipe d'accueil
- Objectifs, missions, problématique, méthodologie
  - Dans quel but, pourquoi c'est intéressant, à quoi cela va servir
- Technologies, outils utilisés
- Connaissances et aptitudes recherchées 
- Quelles données sont utilisées
- Quels sont les livrables attendus
- Durée ou date de début et de fin
- Maitre de stage
